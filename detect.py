        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    #n here is the number of detections per class and names[int(c)] is the label itself.
                now = datetime.now()
                ...
                insertRecord(total_objects.item(),dt_string,time_string)
